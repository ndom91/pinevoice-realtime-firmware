...
#include "../misc/lv_area.h"
    ...
    typedef struct _lv_img_decoder_dsc_t
    {
        ...
        /**The image source. A file path like "/data/prompt/S:my_img.png" or pointer to an `lv_img_dsc_t` variable*/
        const void *src;
     ...
     *  1) File name: E.g. "/data/prompt/S:folder/img1.png" (The drivers needs to registered via `lv_fs_add_drv()`)
