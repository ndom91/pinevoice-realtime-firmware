...
#else
#define CONFIG_BT_RX_STACK_SIZE  (4096+1024) //2048//1536//1024
#endif
#endif
...
#define CONFIG_BT_RX_PRIO (/*configMAX_PRIORITIES - 3*/  configMAX_PRIORITIES + 3)
#endif
/**
...
#define CONFIG_BT_HCI_TX_STACK_SIZE 4096 //1536//1024//200
#endif
...
#define CONFIG_BT_HCI_TX_PRIO (/*configMAX_PRIORITIES - 4*/ /*configMAX_PRIORITIES + 2*/34)
#endif

#ifndef CONFIG_BT_CTLR_RX_PRIO
#define CONFIG_BT_CTLR_RX_PRIO (/*configMAX_PRIORITIES - 3 */ configMAX_PRIORITIES + 3)
#endif
...
#define CONFIG_BT_WORK_QUEUE_STACK_SIZE 2048//1280//512
#else
#define CONFIG_BT_WORK_QUEUE_STACK_SIZE 4096//3072//2048
#endif /* CONFIG_BT_MESH */
#endif
...
#define CONFIG_BT_WORK_QUEUE_PRIO (/*configMAX_PRIORITIES - 2*/configMAX_PRIORITIES+1)
#endif
...
#define CONFIG_BT_RFCOMM_TX_STACK_SIZE  2048//1024
#endif
#ifndef CONFIG_BT_RFCOMM_TX_PRIO
#define CONFIG_BT_RFCOMM_TX_PRIO (/*configMAX_PRIORITIES - 5*/ configMAX_PRIORITIES + 4)
#endif
...
#define xBFLB_BLE_DISCOVER_ONGOING
#endif
