...
//USE TPC_TABLE_SIZE to cross check with header file
#define TPC_TABLE_RATE_SIZE     (sizeof(int8_t [3][8]))
#define TPC_TABLE_OFFSET_SIZE   (sizeof(int8_t [14]))
#define TPC_TABLE_SIZE (TPC_TABLE_RATE_SIZE + TPC_TABLE_OFFSET_SIZE)
#define TPC_TABLE_11B_RATE_SIZE (8)
#define TPC_TABLE_11G_RATE_SIZE (8)
#define TPC_TABLE_11N_RATE_SIZE (8)
