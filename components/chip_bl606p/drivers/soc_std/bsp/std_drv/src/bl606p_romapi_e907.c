...
// __ALWAYS_INLINE ATTR_TCM_SECTION
// BL_Err_Type GLB_Set_Chip_Clock_Out_Sel(GLB_CHIP_CLK_OUT_CFG_Type *cfg){
//     return RomDriver_GLB_Set_Chip_Clock_Out_Sel(cfg);
// }
...
BL_Err_Type GLB_Set_Ethernet_CLK_From_UHSPLL(uint8_t enable){
    return RomDriver_GLB_Set_Ethernet_CLK_From_UHSPLL(enable);
}
...
void SF_Ctrl_Cmds_Set(SF_Ctrl_Cmds_Cfg *cmdsCfg){
    return RomDriver_SF_Ctrl_Cmds_Set(cmdsCfg);
}
...
__ALWAYS_INLINE ATTR_TCM_SECTION
void SF_Ctrl_Select_Bank(SF_Ctrl_Bank_Select bank){
    return RomDriver_SF_Ctrl_Select_Bank(bank);
}
...
BL_Err_Type SFlash_Cache_Read_Enable(SPI_Flash_Cfg_Type *flashCfg, SF_Ctrl_IO_Type ioMode, uint8_t contRead){
    return RomDriver_SFlash_Cache_Read_Enable(flashCfg,ioMode,contRead);
}
