...
#define BFLB_USB_IRQ_NUM             USB_IRQn
#define bflb_mtimer_delay_us(x)      arch_delay_us(x)
#define bflb_mtimer_delay_ms(x)      arch_delay_ms(x)
#define bflb_irq_attach(x, y, z)     csi_irq_attach(x, y, (void *)&g_usb0)
#define bflb_irq_enable(x)           csi_irq_enable(x)
...
#if defined(BL616) || CFG_CHIP_BL606P == 1
