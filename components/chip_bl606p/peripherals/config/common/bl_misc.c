 ...
 *******************************************************************************/
__WEAK__
void *ATTR_TCM_SECTION bl_arch_memcpy(void *dst, const void *src, uint32_t n)
{
    const uint8_t *p = src;
    uint8_t *q = dst;
 ...
 *******************************************************************************/
__WEAK__
uint32_t *ATTR_TCM_SECTION bl_arch_memcpy4(uint32_t *dst, const uint32_t *src, uint32_t n)
{
 ...
 *******************************************************************************/
__WEAK__
void *ATTR_TCM_SECTION bl_arch_memcpy_fast(void *pdst, const void *psrc, uint32_t n)
{
 ...
 *******************************************************************************/
__WEAK__
void *ATTR_TCM_SECTION bl_arch_memset(void *s, uint8_t c, uint32_t n)
{
    uint8_t *p = (uint8_t *)s;
 ...
 *******************************************************************************/
__WEAK__
uint32_t *ATTR_TCM_SECTION bl_arch_memset4(uint32_t *dst, const uint32_t val, uint32_t n)
{
    uint32_t *q = dst;
 ...
 *******************************************************************************/
__WEAK__
int ATTR_TCM_SECTION bl_arch_memcmp(const void *s1, const void *s2, uint32_t n)
{
