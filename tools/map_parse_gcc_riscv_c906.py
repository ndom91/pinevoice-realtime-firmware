...
def get_mem_info(map_file):
    ...
    with open(map_file, 'r') as f:
        ...
        for module in modules:
            ...
            map_lines.append('| %-40s | %-8d  | %-8d | %-8d | %-8d |'%(re.sub('\.[ao]','',module)[:40],rom_size,ram_size, region_size_module['L2SRAM'], region_size_module['PSRAM']))

    print '\n                                         C906 MEMORY MAP                                                  '
    print '|=======================================================================================|'
    print '| %-40s | %-8s  | %-8s | %-8s | %-8s |'%('MODULE','ROM','RAM','L2SRAM', 'PSRAM')
    print '|=======================================================================================|'
    for line in map_lines:
        print line
    print '|=======================================================================================|'
    print '| %-40s | %-8d  | %-8d | %-8d | %-8d |'%('TOTAL (bytes)', total_rom, total_ram, region_size['L2SRAM'], region_size['PSRAM'])
    print '|=======================================================================================|'
